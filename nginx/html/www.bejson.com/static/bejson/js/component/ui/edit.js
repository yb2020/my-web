...
function chklen() {
  var strlen;
  strlen = editor.getValue().length;
  alertSuccess({con: "目前长度" + strlen + "文字\n"});
  return;
}
...
function CheckWords() {
  ...
  if (n == 0) alertSuccess({con:"没有发现可疑错别字！"});
  else msgError(rtval);
}
...
function j2f() {
  var k = '';
  var buttonj2f = $("#texteditorExchange");
  var str = editor.getValue();
  if (buttonj2f.text() === '简->繁') {
...
$('#texteditorClearHtml').click(function(){
  formatjs()
});
$('#texteditorAuto').click(function(){
  format()
});
$('#texteditorAdd').click(function(){
  format3()
});
$('#texteditorChange').click(function(){
  format4()
});
$('#texteditorCheck').click(function(){
  CheckWords()
});
$('#texteditorExchange').click(function(){
  j2f()
});
$('#texteditorFont').click(function(){
  chklen()
});