...
//      xmldom.async = false;           // DOMParser is always sync-mode
    ...
    if (root.querySelector('parsererror')) {
        var rootError = root.querySelector('parsererror').innerHTML;
        console.log(rootError)
        document.getElementById("jsonlintResult").innerHTML = 'XML格式错误：\n'+rootError;
