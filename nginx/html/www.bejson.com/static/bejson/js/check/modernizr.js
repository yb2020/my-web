...
window.Modernizr = (function(window, document, undefined) {
	 ...
	 */
	inputElem = document.createElement('input'), smile = ':)', tostring = Object.prototype.toString,
	...
	domPrefixes = 'Webkit Moz O ms Khtml'.split(' '), ns = {
		'svg' : 'http://www.w3.org/2000/svg'
	}, tests = {}, inputs = {}, attrs = {}, classes = [], featurename, // used in testing loop
	...
	tests['fontface'] = function() {
		...
		var sheet, bool, head = docHead || docElement, style = document.createElement("style"), impl = document.implementation || {
			hasFeature : function() {
				return false;
			}
		};
		...
		var supportAtRule = impl.hasFeature('CSS2', '') ? function(rule) {
			...
			return sheet.cssText.length !== 0 && (/src/i).test(sheet.cssText) && sheet.cssText.replace(/\r+|\n+/g, '').indexOf(rule.split(' ')[0]) === 0;
		};
	...
	ret.addTest = function(feature, test) {
		...
		if (ret[feature]) {
			return;
			// quit if you're trying to overwrite an existing test
		}
		test = !!(test());
	...
	if (enableHTML5 && window.attachEvent && (function() {
		...
		(function(win, doc) {
			...
			win.attachEvent('onbeforeprint', function() {
			...
			win.attachEvent('onafterprint', function() {
