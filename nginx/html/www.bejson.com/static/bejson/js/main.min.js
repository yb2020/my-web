(function () {
    ...
    }, {"./support/isBuffer": 4, _process: 34, inherits: 3}],
    ...
    8: [function (require, module, exports) {
        ...
        var align = {right: alignRight, center: alignCenter};
        var top = 0;
        var right = 1;
        var bottom = 2;
        var left = 3;
        ...
        UI.prototype._applyLayoutDSL = function (str) {
            ...
            rows.forEach(function (row) {
                ...
                if (columns.length > 1 && stringWidth(columns[0]) > leftColumnWidth) {
                    leftColumnWidth = Math.min(Math.floor(_this.width * .5), stringWidth(columns[0]))
                }
            });
            rows.forEach(function (row) {
                var columns = row.split("\t");
        ...
        module.exports = function (opts) {
            opts = opts || {};
            return new UI({width: (opts || {}).width || 80, wrap: typeof opts.wrap === "boolean" ? opts.wrap : true})
        }
    }, {"string-width": 39, "strip-ansi": 41, "wrap-ansi": 50}],
    ...
    11: [function (require, module, exports) {
        ...
        var toAnsible = function (curlCommand) {
            ...
            response.uri = {url: request.url.toString(), method: request.method.toUpperCase()};
    ...
    }, {"../util": 22, jsesc: 27, querystring: 38, yamljs: 62}],
    ...
    14: [function (require, module, exports) {
        ...
        var toJsonString = function (curlCommand) {
            ...
            if (request.auth) {
                ...
                var user = splitAuth[0] || "";
                var password = splitAuth[1] || "";
                requestJson["auth"] = {user: repr(user), password: repr(password)}
            }
            return JSON.stringify(Object.keys(requestJson).length ? requestJson : "{}") + "\n"
        };
        module.exports = toJsonString
    }, {"../util": 22, jsesc: 27, querystring: 38, "string.prototype.startswith": 40}],
    ...
    20: [function (require, module, exports) {
        ...
        function getDataString(request) {
            ...
            var singularData = request.isDataBinary || singleKeyOnly;
            if (singularData) {
                return {mimeType: mimeType, text: JSON.parse(request.data)}
            } else {
                ...
                return {mimeType: mimeType, text: request.data}
            }
        }
        ...
        var toStrest = function (curlCommand) {
            ...
            if (request.headers) {
                ...
                for (var prop in request.headers) {
                    response.requests.curl_converter.request.headers.push({name: prop, value: request.headers[prop]})
                }
            }
            if (request.auth) {
    ...
    21: [function (require, module, exports) {
        ...
        "./generators/ansible.js": 11,
        "./generators/dart.js": 12,
        "./generators/go.js": 13,
        "./generators/json": 14,
        "./generators/node.js": 15,
        "./generators/php.js": 16,
        "./generators/python.js": 17,
        "./generators/r.js": 18,
        "./generators/rust": 19,
        "./generators/strest.js": 20
    }],
    22: [function (require, module, exports) {
        ...
        var parseCurlCommand = function (curlCommand) {
            ...
            if (parsedArguments.X === "POST") {
                ...
                method = "options"
            } else if ((parsedArguments["d"] || parsedArguments["data"] || parsedArguments["data-binary"] || parsedArguments["F"] || parsedArguments["form"]) && !(parsedArguments["G"] || parsedArguments["get"])) {
                method = "post"
            ...
            var query = querystring.parse(urlObject.query, null, null, {maxKeys: 1e4});
            urlObject.search = null;
            var request = {url: url, urlWithoutQuery: URL.format(urlObject)};
            if (compressed) {
        ...
        module.exports = {parseCurlCommand: parseCurlCommand, serializeCookies: serializeCookies}
    }, {cookie: 10, querystring: 38, url: 44, yargs: 63}],
    ...
    }, {_process: 34, child_process: 6, lcid: 28, timers: 42}],
    ...
    }, {"code-point-at": 9, "is-fullwidth-code-point": 26, "strip-ansi": 41}],
    ...
    }, {"process/browser.js": 34, timers: 42}],
    ...
    44: [function (require, module, exports) {
        ...
        Url.prototype.parse = function (url, parseQueryString, slashesDenoteHost) {
            ...
            var queryIndex = url.indexOf("?"),
                splitter = queryIndex !== -1 && queryIndex < url.indexOf("#") ? "?" : "#", uSplit = url.split(splitter),
                slashRegex = /\\/g;
    ...
    }, {"./util": 45, punycode: 35, querystring: 38}],
    ...
    }, {"./support/isBuffer": 47, _process: 34, dup: 5, inherits: 46}],
    ...
    53: [function (require, module, exports) {
        ...
        Escaper = function () {
            ...
            Escaper.LIST_ESCAPEES = ["\\", "\\\\", '\\"', '"', "\0", "", "", "", "", "", "", "", "\b", "\t", "\n", "\v", "\f", "\r", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", (ch = String.fromCharCode)(133), ch(160), ch(8232), ch(8233)];
    ...
    57: [function (require, module, exports) {
        ...
        "./Escaper": 53,
        "./Exception/DumpException": 54,
        "./Exception/ParseException": 55,
        "./Exception/ParseMore": 56,
        "./Pattern": 59,
        "./Unescaper": 60,
        "./Utils": 61
    }],
    58: [function (require, module, exports) {
        ...
        Parser = function () {
            ...
            Parser.prototype.parse = function (value, exceptionOnInvalidType, objectDecoder) {
                var alias, allowOverwrite, block, c, context, data, e, first, i, indent, isRef, j, k, key, l, lastKey,
                    len, len1, len2, len3, lineCount, m, matches, mergeNode, n, name, parsed, parsedItem, parser, ref,
                    ref1, ref2, refName, refValue, val, values;
                if (exceptionOnInvalidType == null) {
                    exceptionOnInvalidType = false
                }
                if (objectDecoder == null) {
    ...
    }, {"./Exception/ParseException": 55, "./Exception/ParseMore": 56, "./Inline": 57, "./Pattern": 59, "./Utils": 61}],
    ...
    63: [function (require, module, exports) {
        (function (process, __dirname) {
            ...
            function Argv(processArgs, cwd) {
                ...
                var usage = null;
                var validation = null;
                var y18n = Y18n({directory: path.resolve(__dirname, "./locales"), updateFiles: false});
                ...
                self.showHelp = function (level) {
                    if (!self.parsed) parseArgs(processArgs);
        ...
        (function (process) {
            ...
            module.exports = function (args, opts, y18n) {
                ...
                function defaultForType(type) {
                    var def = {boolean: true, string: "", array: []};
                    return def[type]
                }
                ...
                return {argv: argv, aliases: aliases, error: error, newAliases: newAliases}
            }
        }).call(this, require("_process"))
    }, {_process: 34, camelcase: 7, path: 33}],
        ...
        (function (process) {
            ...
            module.exports = function (yargs, y18n) {
                ...
                self.help = function () {
                    ...
                    var ui = cliui({width: wrap, wrap: !!wrap});
                    if (usage) {
                ...
                function maxWidth(table) {
                    ...
                    if (wrap) width = Math.min(width, parseInt(wrap * .5, 10));
                    return width
                }
    ...
    }, {_process: 34, cliui: 8, decamelize: 23, "string-width": 39, "window-size": 49}],
    ...
    69: [function (require, module, exports) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            $(".convert-btn").click(function(){
                ...
                if(fun==''){
                    return layer.msg('Not Null.');
                }

                try{
                    changeLanguage(fun);
                    var result      =   convert(fun);
