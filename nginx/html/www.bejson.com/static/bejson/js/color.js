window.SINGLE_TAB = "  ";
window.ImgCollapsed = "/static/bejson/img/Collapsed.gif";
window.ImgExpanded = "/static/bejson/img/Expanded.gif";
window.QuoteKeys = true;
// window.unicode2chcheck = true;
...
// function unicodeToCodeClicked(){
//
//     window.unicode2chcheck = $id("unicodeToCode").checked;
//
//     Process();
//
// }
