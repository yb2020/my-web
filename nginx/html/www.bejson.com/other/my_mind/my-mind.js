...
${text}`);
  ...
  new class Value extends Command {
    ...
    execute() {
      ...
      let newValue = prompt("设置值", String(oldValue));
      if (newValue == null) {
        return;
      }
      if (!newValue.length) {
